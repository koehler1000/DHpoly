...
public class SpielerUI extends Oberflaeche implements Beobachter // NOSONAR
{
	...
	public SpielerUI(Spieler spieler, SpielfeldAnsicht ansicht)
	{
		...
		butHausBau.addActionListener(e -> ansicht.zeigeHausbaumoeglichkeit(spieler.getDaten().getStrassen()));
		...
		butHandel.addActionListener(e -> new Transaktion(ansicht.getSpieler(), spieler.getDaten()).anzeigen(ansicht));
