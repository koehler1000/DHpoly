...
// {
// Spieler ziehenderSpieler = new SpielerImpl("foo", 500, null);
//
// List<Spieler> spieler = new ArrayList<>();
// spieler.add(ziehenderSpieler);
// spieler.add(new SpielerImpl("bar", 100, null));
// spieler.add(new SpielerImpl("ich", 100, null));
//
// BezahlKarte karte = new BezahlKarte("bla",
// GeldTransfer.ANDERESPIELER_SPIELER, 50);
//
// Kartenverbucher verbucher = new KartenverbucherImpl();
...
//
// BezahlKarte karte = new BezahlKarte("bla",
// GeldTransfer.SPIELER_ANDERESPIELER, 50);
//
// Kartenverbucher verbucher = new KartenverbucherImpl();
// verbucher.bewegeGeld(karte, spieler, ziehenderSpieler);
//
